<<<<<<< HEAD
// homeController.js đã được gộp vào productController.js
// File này giữ lại để không break require() nếu có
// Mọi logic home đã chuyển sang productController.getHome
module.exports = {}
=======
...
// }
exports.getHome = async (req, res) => {
  if (homeHTML && Date.now() - cacheTime < 30000) {
  ...
  res.render('pages/home', { featured, categories }, (err, html) => {
    homeHTML = html
    cacheTime = Date.now()
    res.send(html)
  })
